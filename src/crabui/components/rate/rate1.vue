...
export default defineComponent({
    ...
    setup(props) {
        ...
        const changeValue = (score: number, event: MouseEmit) => {
            if (props.half) {
        ...
        const validateWithTrigger = () =>
            nextTick(() =>
                vt(['onChange'], 'onChange', props.rules, props.modelValue)
            )

        const handleClick = (score: number, event: MouseEmit) => {
