...
export const routes = [
    ...
    },
    {
        path: '/pages/componentsA/cell/cell',
        name: 'cell',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/cell/cell.nvue', {
            pageType: 'top'
        })
    },
    {
    ...
    },
    {
        path: '/pages/componentsA/gap/gap',
        name: 'gap',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/gap/gap.nvue', {
            pageType: 'top'
        })
    },
    {
        path: '/pages/componentsA/link/link',
        name: 'link',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/link/link.nvue', {
            pageType: 'top'
        })
    },
    {
        path: '/pages/componentsA/transition/transition',
        name: 'transition',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/transition/transition.nvue', {
            pageType: 'top'
        })
    },
    {
    ...
    },
    {
        path: '/pages/componentsA/grid/grid',
        name: 'grid',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/grid/grid.nvue', {
            pageType: 'top'
        })
    },
    {
        path: '/pages/componentsA/sticky/sticky',
        name: 'sticky',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/sticky/sticky.nvue', {
            pageType: 'top'
        })
    },
    {
        path: '/pages/componentsA/divider/divider',
        name: 'divider',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/divider/divider.nvue', {
            pageType: 'top'
        })
    },
    {
        path: '/pages/componentsA/backtop/backtop',
        name: 'backtop',
        component: __dynamicImportComponent__('@/crabui-doc/componentsA/backtop/backtop.nvue', {
            pageType: 'top'
        })
    }
